...
import { Image, Carousel, Row, Col, Button, Typography, Layout, Pagination } from 'antd';
                ...
                <div className="row">
                    <div className="col-12 col-md-6 text-start my-5">
                        ...
                        <p style={{ color: "#08979c" }}>
                            Faculty of Information Technology announces the list of qualified applicants to be interview on Thursday, June 13, 2019 at Faculty of Information Technology Building, 1st Floor, Room M04, KMITL.
                        </p>
                        <Button type="primary" shape="round" size="large" onClick={() => location.href = '/news'}>
                            <span >
                                อ่านเพิ่มเติม
                            </span>
                        </Button>
                    ...
                    <div className="col-12 col-md-6">
                        ...
                        <div className="news-img">
                            <img src="https://www.it.kmitl.ac.th/wp-content/uploads/2019/06/1300x867_BSC_TCAS-5-2562-ANNOUCEMENT-OF-QUALIFIED-CANDIDATES-FOR-INTERVIEW.jpg" width="100%" />
                        </div>
        ...
        <div className="container my-5">
            ...
            <div className="row">
                <div className="col-12">
                    <div className="news" >
                        <div className="news-main" style={{ color: "#f5f5f5", backgroundColor: "#112B3C" }} >
                            <div className="news-img"><img src="https://www.it.kmitl.ac.th/wp-content/uploads/2019/06/1300x867_BSC_TCAS-5-2562-ANNOUCEMENT-OF-QUALIFIED-CANDIDATES-FOR-INTERVIEW.jpg" width="100%" /></div>
                            <div className="m-2" style={{ color: "#f5f5f5", backgroundColor: "#112B3C" }}>
